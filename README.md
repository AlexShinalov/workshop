...
# Final Boss
## История
Как бы это не было комично, это действительно пк для работы. Данная сборка делалась для отца моего друга, который уже многие годы занимается созданием текстур, анимаций и всякого рода графики в играх. Как пример - последние Герои (на 2024 год), в их создании Иван Николаевич (имя изменено) принимал непосредственное участие. По-сути, бюджета не было, была задача - собрать максимально производительный, но при этом сбалансированный комп, которого хватит на многие годы вперед. Именно поэтому в этой сборке нет 4080 и последнего core i9, нам хотелось выдержать оптимальный баланс цена/мощность, чтобы качественно, но без лишних понтов.
